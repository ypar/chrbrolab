...
I generated allele counts using star 2-pass alignment, wasp qc processing steps and samtools. Example scripts are [here](https://github.com/ypar/chrbrolab/tree/master/gtex/data_processing). Allele counts generated by LDACC using tophat v1.4 aligned bam files are available on dbGaP.
